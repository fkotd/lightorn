...
void CollisionResponseSystem::Update(World& world)
{
...
// TODO: add comments
float CollisionResponseSystem::SweptAABB(const sf::FloatRect& r1, const sf::FloatRect& r2, sf::Vector2f& v1, sf::Vector2f& v2, sf::Vector2f& normal)
{
